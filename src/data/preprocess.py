...
def load_data(dataset, output_folder, data_folder):
	...
	if dataset == 'synthetic':
		...
		for filename in file_list:
			if filename.endswith('.txt'):
				...
				s = load_and_save('test', filename, filename.strip('.txt'), dataset_folder, output_folder)
				load_and_save2('labels', filename, filename.strip('.txt'), dataset_folder, s, output_folder)
	elif dataset == 'UCR':
